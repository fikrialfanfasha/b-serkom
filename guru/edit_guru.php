...
if ($_POST) {
  ...
  $query = "UPDATE Guru SET NamaLengkap = '$nama_lengkap', Jabatan = '$jabatan' WHERE NIP = '$nip'";
    ...
    <nav class="navbar bg-white border-bottom px-3">
      ...
      <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h2><i class="fas fa-edit me-2"></i> Edit Guru</h2>
          ...
          <div class="card-body">
            <form method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?= $guru['NamaLengkap']; ?>" required>
              </div>
              <div class="mb-3">
