...
if ($_POST) {
  ...
  $query = "UPDATE Siswa SET NamaLengkap = '$nama_lengkap', Kelas = '$kelas', JenisKelamin = '$jenis_kelamin' WHERE NIS = '$nis'";
    ...
    <nav class="navbar bg-white border-bottom px-3">
      ...
      <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h2><i class="fas fa-edit me-2"></i> Edit Siswa</h2>
          <a href="siswa.php" class="btn btn-secondary"><i class="fas fa-arrow-left me-2"></i>Kembali</a>
        </div>
          ...
          <div class="card-body">
            <form method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?= $siswa['NamaLengkap']; ?>" required>
              </div>
              <div class="mb-3">
